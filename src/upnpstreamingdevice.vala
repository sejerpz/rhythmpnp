...
public class UPnPStreamingDevice : IUPnPDevice, RB.StreamingSource
{
	...
	public UPnPStreamingDevice (DeviceProxy device, ServiceProxy service_proxy, RB.Plugin plugin, RB.Shell shell)
	{
		var db = shell.db;
