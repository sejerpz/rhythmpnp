...
public class UPnPMediaLibraryDevice : IUPnPDevice, RB.BrowserSource
{
	...
	public UPnPMediaLibraryDevice (DeviceProxy device, ServiceProxy service_proxy, RB.Plugin plugin, RB.Shell shell)
	{
		var db = shell.db;
